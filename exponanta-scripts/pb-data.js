Every record in record.data is exactly copying json structure  of Frappe. there is also record.meta and record.users that I can use to set up Permissions
...
GROUP BY u.name, json_extract(u.data, '$.email');Data is produced through user interactions and system processes."
    }
}
