// I have this component that renders frappe docs and correspondent schemas stored in pocketbase. Please give me minimal code to complement current container with Approval widget  from correspondent workflow for related doctype
// (do NOT change my code, generate complementary code and show lines where to put in my snippet to add approval widget on top of existing document from workfow . 
(function() {
...
//Use the following 1)  workflow stored exactly as frappe docswith transitions docs  document states in the same collection. 2) 
// use exisitng and preloaded pb.js functtions  
(function() {
