...
CW.Schema.Role = {
  ...
  fields: [
    { fieldname: "role_name", fieldtype: "Data", reqd: 1, in_list_view: 1 },
    { fieldname: "disabled", fieldtype: "Check", default: 0 },
  ],
};
...
CW.Schema.Task = {
  ...
  fields: [
    { fieldname: "subject", fieldtype: "Data", reqd: 1, in_list_view: 1 },
    {
      fieldname: "priority",
      fieldtype: "Select",
      options: "Low\nMedium\nHigh",
  ...
  _state: {
    status: {
      ...
      transitions: {
        ...
        Active: ["Locked", "Reset Pending", "Disabled"],
        Locked: ["Active", "Disabled"],
        "Reset Pending": ["Active", "Disabled"],
        Disabled: ["Invited"],
      },
      labels: {
        "Invited.Active": "Activate",
        "Invited.Disabled": "Cancel Invitation",
        "Active.Locked": "Lock Account",
        "Active.Reset Pending": "Require Password Reset",
        "Active.Disabled": "Disable User",
        "Locked.Active": "Unlock Account",
        "Reset Pending.Active": "Complete Reset",
        "Disabled.Invited": "Re-invite",
      },
      sideEffects: {},
      rules: {},
    },
  ...
  permissions: [
    {
      ...
      delete: 1,
      transitions: {
        "status.Invited.Active": "Activate",
  ...
  systemFields: [
    ...
    },
    {
      ...
      onCreate: (run_doc) => {
        ...
        if (doc)
          doc.owner =
            doc.doctype === "User" ? "" : globalThis.currentUser?.id || "";
      },
    },
    {
      name: "modified",
    ...
    },
    {
      ...
      onWrite: (run_doc) => {
        const doc = run_doc.target?.data?.[0];
        if (doc) doc.modified_by = globalThis.currentUser?.id || "";
      },
    },
    {
      name: "top_parent",
...
// after _config is fully defined
